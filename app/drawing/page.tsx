...
export default function DrawingPage() {
  ...
  const totalCount = STATIC_DRAWINGS.length + customDrawings.length;
  ...
  return (
    <div className="min-h-screen bg-[#f9f9ff] flex flex-col">
      ...
      {/* 새 도면 팝업 */}
      {showModal && (
        <div className="fixed inset-0 bg-gray-900/50 flex items-end justify-center z-50 px-0">
          <div className="bg-white w-full max-w-sm rounded-t-3xl px-6 pt-6 pb-10 flex flex-col gap-5">
            {/* 팝업 헤더 */}
